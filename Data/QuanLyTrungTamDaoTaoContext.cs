...
//        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-EHPQLIHN\\SQLEXPRESS;Initial Catalog=QuanLyTrungTamDaoTao;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaQuanTriVien).HasName("PK__QuanTriV__6112BB3B98BFCD8B");
